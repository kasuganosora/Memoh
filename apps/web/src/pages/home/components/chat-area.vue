          ...
          <section class="absolute inset-0">
            ...
            >
              <div class="w-full max-w-4xl mx-auto px-10 py-6 space-y-6">
                ...
                >
                  <p v-if="activeSession?.type === 'subagent'" class="text-muted-foreground text-xs">
                    {{ $t('chat.emptySubagent') }}
                  </p>
                  <p v-else-if="activeSession?.type === 'heartbeat' || activeSession?.type === 'schedule'" class="text-muted-foreground text-xs">
