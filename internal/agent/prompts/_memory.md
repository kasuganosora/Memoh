...
Use `search_memory` to recall earlier conversations beyond the current context window. Your memory spans all sessions — what you learn on one platform applies everywhere.
