...
const (
	...
	ExecOutput_BACKGROUND ExecOutput_Stream = 3
)
...
type ExecStatusResponse_Status int32

const (
	ExecStatusResponse_RUNNING   ExecStatusResponse_Status = 0
	ExecStatusResponse_EXITED    ExecStatusResponse_Status = 1
	ExecStatusResponse_NOT_FOUND ExecStatusResponse_Status = 2
)

// Enum value maps for ExecStatusResponse_Status.
var (
	ExecStatusResponse_Status_name = map[int32]string{
		0: "RUNNING",
		1: "EXITED",
		2: "NOT_FOUND",
	}
	ExecStatusResponse_Status_value = map[string]int32{
		"RUNNING":   0,
		"EXITED":    1,
		"NOT_FOUND": 2,
	}
...
func (x ExecStatusResponse_Status) Enum() *ExecStatusResponse_Status {
	p := new(ExecStatusResponse_Status)
	*p = x
	return p
}

func (x ExecStatusResponse_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ExecStatusResponse_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_workspace_bridgepb_bridge_proto_enumTypes[1].Descriptor()
}

func (ExecStatusResponse_Status) Type() protoreflect.EnumType {
	return &file_internal_workspace_bridgepb_bridge_proto_enumTypes[1]
}

func (x ExecStatusResponse_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ExecStatusResponse_Status.Descriptor instead.
func (ExecStatusResponse_Status) EnumDescriptor() ([]byte, []int) {
	return file_internal_workspace_bridgepb_bridge_proto_rawDescGZIP(), []int{23, 0}
}
...
func (x *ExecStatusRequest) Reset() {
	*x = ExecStatusRequest{}
...
func (x *ExecStatusRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecStatusRequest) ProtoMessage() {}

func (x *ExecStatusRequest) ProtoReflect() protoreflect.Message {
	mi := &file_internal_workspace_bridgepb_bridge_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExecStatusRequest.ProtoReflect.Descriptor instead.
func (*ExecStatusRequest) Descriptor() ([]byte, []int) {
	return file_internal_workspace_bridgepb_bridge_proto_rawDescGZIP(), []int{22}
}

func (x *ExecStatusRequest) GetExecId() string {
	if x != nil {
		return x.ExecId
	}
	return ""
...
type ExecStatusResponse struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	Status        ExecStatusResponse_Status `protobuf:"varint,1,opt,name=status,proto3,enum=bridgepb.ExecStatusResponse_Status" json:"status,omitempty"`
...
func (x *ExecStatusResponse) Reset() {
	*x = ExecStatusResponse{}
	mi := &file_internal_workspace_bridgepb_bridge_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ExecStatusResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecStatusResponse) ProtoMessage() {}

func (x *ExecStatusResponse) ProtoReflect() protoreflect.Message {
	mi := &file_internal_workspace_bridgepb_bridge_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExecStatusResponse.ProtoReflect.Descriptor instead.
func (*ExecStatusResponse) Descriptor() ([]byte, []int) {
	return file_internal_workspace_bridgepb_bridge_proto_rawDescGZIP(), []int{23}
}

func (x *ExecStatusResponse) GetStatus() ExecStatusResponse_Status {
	if x != nil {
		return x.Status
	}
	return ExecStatusResponse_RUNNING
}

func (x *ExecStatusResponse) GetStdout() string {
	if x != nil {
		return x.Stdout
	}
	return ""
...
func (x *ExecStatusResponse) GetStderr() string {
	if x != nil {
		return x.Stderr
	}
	return ""
...
func (x *ExecStatusResponse) GetExitCode() int32 {
	if x != nil {
		return x.ExitCode
	}
	return 0
...
func (x *ExecStatusResponse) GetCommand() string {
	if x != nil {
		return x.Command
	}
	return ""
...
func (x *ExecStatusResponse) GetStartedAt() int64 {
	if x != nil {
		return x.StartedAt
	}
	return 0
...
func (x *ExecStatusResponse) GetFinishedAt() int64 {
	if x != nil {
		return x.FinishedAt
	}
	return 0
...
const file_internal_workspace_bridgepb_bridge_proto_rawDesc = "" +
	...
	"\aexec_id\x18\x04 \x01(\tR\x06execId\":\n" +
	"\x06Stream\x12\n" +
	"\n" +
	"\x06STDOUT\x10\x00\x12\n" +
	"\n" +
	"\x06STDERR\x10\x01\x12\b\n" +
	"\x04EXIT\x10\x02\x12\x0e\n" +
	"\n" +
	"BACKGROUND\x10\x03\"$\n" +
	...
	"\x0eRenameResponse\",\n" +
	"\x11ExecStatusRequest\x12\x17\n" +
	"\aexec_id\x18\x01 \x01(\tR\x06execId\"\xaa\x02\n" +
	"\x12ExecStatusResponse\x12;\n" +
	"\x06status\x18\x01 \x01(\x0e2#.bridgepb.ExecStatusResponse.StatusR\x06status\x12\x16\n" +
	...
	"\n" +
	"DeleteFile\x12\x1b.bridgepb.DeleteFileRequest\x1a\x1c.bridgepb.DeleteFileResponse\x12G\n" +
	"\n" +
	"ExecStatus\x12\x1b.bridgepb.ExecStatusRequest\x1a\x1c.bridgepb.ExecStatusResponseB6Z4github.com/memohai/memoh/internal/workspace/bridgepbb\x06proto3"
...
var file_internal_workspace_bridgepb_bridge_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_internal_workspace_bridgepb_bridge_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_internal_workspace_bridgepb_bridge_proto_goTypes = []any{
	(ExecOutput_Stream)(0),         // 0: bridgepb.ExecOutput.Stream
	(ExecStatusResponse_Status)(0), // 1: bridgepb.ExecStatusResponse.Status
	(*ReadFileRequest)(nil),        // 2: bridgepb.ReadFileRequest
	(*ReadFileResponse)(nil),       // 3: bridgepb.ReadFileResponse
	(*WriteFileRequest)(nil),       // 4: bridgepb.WriteFileRequest
	(*WriteFileResponse)(nil),      // 5: bridgepb.WriteFileResponse
	(*ListDirRequest)(nil),         // 6: bridgepb.ListDirRequest
	(*FileEntry)(nil),              // 7: bridgepb.FileEntry
	(*ListDirResponse)(nil),        // 8: bridgepb.ListDirResponse
	(*ExecInput)(nil),              // 9: bridgepb.ExecInput
	(*TerminalResize)(nil),         // 10: bridgepb.TerminalResize
	(*ExecOutput)(nil),             // 11: bridgepb.ExecOutput
	(*ReadRawRequest)(nil),         // 12: bridgepb.ReadRawRequest
	(*DataChunk)(nil),              // 13: bridgepb.DataChunk
	(*WriteRawChunk)(nil),          // 14: bridgepb.WriteRawChunk
	(*WriteRawResponse)(nil),       // 15: bridgepb.WriteRawResponse
	(*DeleteFileRequest)(nil),      // 16: bridgepb.DeleteFileRequest
	(*DeleteFileResponse)(nil),     // 17: bridgepb.DeleteFileResponse
	(*StatRequest)(nil),            // 18: bridgepb.StatRequest
	(*StatResponse)(nil),           // 19: bridgepb.StatResponse
	(*MkdirRequest)(nil),           // 20: bridgepb.MkdirRequest
	(*MkdirResponse)(nil),          // 21: bridgepb.MkdirResponse
	(*RenameRequest)(nil),          // 22: bridgepb.RenameRequest
	(*RenameResponse)(nil),         // 23: bridgepb.RenameResponse
	(*ExecStatusRequest)(nil),      // 24: bridgepb.ExecStatusRequest
	(*ExecStatusResponse)(nil),     // 25: bridgepb.ExecStatusResponse
}
var file_internal_workspace_bridgepb_bridge_proto_depIdxs = []int32{
	7,  // 0: bridgepb.ListDirResponse.entries:type_name -> bridgepb.FileEntry
	10, // 1: bridgepb.ExecInput.resize:type_name -> bridgepb.TerminalResize
	0,  // 2: bridgepb.ExecOutput.stream:type_name -> bridgepb.ExecOutput.Stream
	7,  // 3: bridgepb.StatResponse.entry:type_name -> bridgepb.FileEntry
	1,  // 4: bridgepb.ExecStatusResponse.status:type_name -> bridgepb.ExecStatusResponse.Status
	2,  // 5: bridgepb.ContainerService.ReadFile:input_type -> bridgepb.ReadFileRequest
	4,  // 6: bridgepb.ContainerService.WriteFile:input_type -> bridgepb.WriteFileRequest
	6,  // 7: bridgepb.ContainerService.ListDir:input_type -> bridgepb.ListDirRequest
	18, // 8: bridgepb.ContainerService.Stat:input_type -> bridgepb.StatRequest
	20, // 9: bridgepb.ContainerService.Mkdir:input_type -> bridgepb.MkdirRequest
	22, // 10: bridgepb.ContainerService.Rename:input_type -> bridgepb.RenameRequest
	9,  // 11: bridgepb.ContainerService.Exec:input_type -> bridgepb.ExecInput
	12, // 12: bridgepb.ContainerService.ReadRaw:input_type -> bridgepb.ReadRawRequest
	14, // 13: bridgepb.ContainerService.WriteRaw:input_type -> bridgepb.WriteRawChunk
	16, // 14: bridgepb.ContainerService.DeleteFile:input_type -> bridgepb.DeleteFileRequest
	24, // 15: bridgepb.ContainerService.ExecStatus:input_type -> bridgepb.ExecStatusRequest
	3,  // 16: bridgepb.ContainerService.ReadFile:output_type -> bridgepb.ReadFileResponse
	5,  // 17: bridgepb.ContainerService.WriteFile:output_type -> bridgepb.WriteFileResponse
	8,  // 18: bridgepb.ContainerService.ListDir:output_type -> bridgepb.ListDirResponse
	19, // 19: bridgepb.ContainerService.Stat:output_type -> bridgepb.StatResponse
	21, // 20: bridgepb.ContainerService.Mkdir:output_type -> bridgepb.MkdirResponse
	23, // 21: bridgepb.ContainerService.Rename:output_type -> bridgepb.RenameResponse
	11, // 22: bridgepb.ContainerService.Exec:output_type -> bridgepb.ExecOutput
	13, // 23: bridgepb.ContainerService.ReadRaw:output_type -> bridgepb.DataChunk
	15, // 24: bridgepb.ContainerService.WriteRaw:output_type -> bridgepb.WriteRawResponse
	17, // 25: bridgepb.ContainerService.DeleteFile:output_type -> bridgepb.DeleteFileResponse
	25, // 26: bridgepb.ContainerService.ExecStatus:output_type -> bridgepb.ExecStatusResponse
