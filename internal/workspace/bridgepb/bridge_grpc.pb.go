...
const (
	...
	ContainerService_ExecStatus_FullMethodName = "/bridgepb.ContainerService/ExecStatus"
)
...
type ContainerServiceClient interface {
	...
	ExecStatus(ctx context.Context, in *ExecStatusRequest, opts ...grpc.CallOption) (*ExecStatusResponse, error)
}
...
func (c *containerServiceClient) ExecStatus(ctx context.Context, in *ExecStatusRequest, opts ...grpc.CallOption) (*ExecStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ExecStatusResponse)
	err := c.cc.Invoke(ctx, ContainerService_ExecStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ContainerServiceServer interface {
	...
	ExecStatus(context.Context, *ExecStatusRequest) (*ExecStatusResponse, error)
...
func (UnimplementedContainerServiceServer) ExecStatus(context.Context, *ExecStatusRequest) (*ExecStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ExecStatus not implemented")
}
...
func _ContainerService_ExecStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExecStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ContainerServiceServer).ExecStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ContainerService_ExecStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ContainerServiceServer).ExecStatus(ctx, req.(*ExecStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ContainerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ExecStatus",
			Handler:    _ContainerService_ExecStatus_Handler,
		},
	},
