 ...
 *
 * Long-poll the QR code scan status. On confirmed, auto-saves credentials.
 */
export const postBotsByIdChannelWeixinQrPollMutation = (options?: Partial<Options<PostBotsByIdChannelWeixinQrPollData>>): UseMutationOptions<PostBotsByIdChannelWeixinQrPollResponse, Options<PostBotsByIdChannelWeixinQrPollData>, PostBotsByIdChannelWeixinQrPollError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByIdChannelWeixinQrPoll({
            ...options,
            ...vars,
            throwOnError: true
        });
 ...
 *
 * Fetch a QR code from WeChat for scanning.
 */
export const postBotsByIdChannelWeixinQrStartMutation = (options?: Partial<Options<PostBotsByIdChannelWeixinQrStartData>>): UseMutationOptions<PostBotsByIdChannelWeixinQrStartResponse, Options<PostBotsByIdChannelWeixinQrStartData>, PostBotsByIdChannelWeixinQrStartError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByIdChannelWeixinQrStart({
            ...options,
            ...vars,
            throwOnError: true
        });
