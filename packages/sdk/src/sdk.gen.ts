 ...
 */
export const postBotsByIdChannelWeixinQrPoll = <ThrowOnError extends boolean = false>(options: Options<PostBotsByIdChannelWeixinQrPollData, ThrowOnError>) => (options.client ?? client).post<PostBotsByIdChannelWeixinQrPollResponses, PostBotsByIdChannelWeixinQrPollErrors, ThrowOnError>({
 ...
 */
export const postBotsByIdChannelWeixinQrStart = <ThrowOnError extends boolean = false>(options: Options<PostBotsByIdChannelWeixinQrStartData, ThrowOnError>) => (options.client ?? client).post<PostBotsByIdChannelWeixinQrStartResponses, PostBotsByIdChannelWeixinQrStartErrors, ThrowOnError>({ url: '/bots/{id}/channel/weixin/qr/start', ...options });
